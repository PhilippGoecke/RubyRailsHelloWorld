...
podman run --interactive --tty --read-only --cap-drop=ALL --security-opt=no-new-privileges:true --tmpfs /tmp:rw,noexec,nosuid --user nobody --pids-limit 256 --memory 512m --cpus 1 --publish 3000:3000 rails:demo
